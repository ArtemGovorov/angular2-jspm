...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var k,
          ...
          j = function() {
            var a = !1,
                d = function(b) {
                  var a = new c(b);
                  return D(a, d.prototype), a;
                };
            try {
              if (a = c && c.resolve && z(), D(d, c), d.prototype = l.create(c.prototype, {constructor: {value: d}}), d.resolve(5).then(function() {}) instanceof d || (a = !1), a && b(8)) {
                var e = !1;
          ...
          C = function(a) {
            var b;
            return H(a) && "function" == typeof(b = a.then) ? b : !1;
          },
          i = function(a) {
            return B(c, a) ? new t(a) : new u(a);
          },
          t = u = function(d) {
            var b,
                c;
                ...
                for (var d = a._v,
                    ...
                    g = function(b) {
                      var c,
                          ...
                          f = b.reject;
                      try {
                        g ? (e || (2 == a._h && I(a), a._h = 1), c = g === !0 ? d : g(d), c === b.promise ? f(m("Promise-chain cycle")) : (h = C(c)) ? h.call(c, i, f) : i(c)) : f(d);
                      } catch (j) {
                        f(j);
                      }
                    }; b.length > f; )
                  g(b[f++]);
                a._c = [], a._n = !1, c && !a._h && G(a);
              });
            }
          },
          G = function(b) {
            s.call(e, function() {
              if (v(b)) {
                var f,
                    c,
                    d = b._v;
                y ? n.emit("unhandledRejection", d, b) : (f = e.onunhandledrejection) ? f({
                  promise: b,
                  reason: d
          ...
          I = function(a) {
            s.call(e, function() {
              var b;
              y ? n.emit("rejectionHandled", a) : (b = e.onrejectionhandled) && b({
                promise: a,
                reason: a._v
              });
            });
          ...
          h = function(b) {
            var a = this;
            a._d || (a._d = !0, a = a._w || a, a._v = b, a._s = 2, a._a || (a._a = a._c.slice()), p(a, !0));
          },
          o = function(b) {
            var c,
                a = this;
      ...
      j || (c = function Promise(a) {
        F(this, c, f, "_h"), q(a), k.call(this);
        try {
          a(g(o, this, 1), g(h, this, 1));
        } catch (b) {
          h.call(this, b);
        }
      }, k = function Promise(b) {
        this._c = [], this._a = a, this._s = 0, this._d = !1, this._v = a, this._h = 0, this._n = !1;
      }, k.prototype = b(158)(c.prototype, {
        then: function then(b, d) {
          var a = i(E(this, c));
          return a.ok = "function" == typeof b ? b : !0, a.fail = "function" == typeof d && d, this._c.push(a), this._a && this._a.push(a), this._s && p(this, !1), a.promise;
        },
        "catch": function(b) {
        ...
        var a = new k;
        this.promise = a, this.resolve = g(o, a, 1), this.reject = g(h, a, 1);
      }), d(d.G + d.W + d.F * !j, {Promise: c}), b(37)(c, f), b(137)(f), w = b(5)[f], d(d.S + d.F * !j, f, {reject: function reject(b) {
          var a = i(this),
              c = a.reject;
          return c(b), a.promise;
        }}), d(d.S + d.F * (!j || z(!0)), f, {resolve: function resolve(a) {
          if (a instanceof c && B(a.constructor, this))
            return a;
          var b = i(this),
              d = b.resolve;
          return d(a), b.promise;
        }}), d(d.S + d.F * !(j && b(131)(function(a) {
 ...
 while (!((c = d[b._i++]) in b._t));
      ...
      var a = b(3);
      a(a.G + a.W + a.F * !b(183).ABV, {DataView: b(184).DataView});
    }, function(b, c, a) {
      a(187)("Int8", 1, function(a) {
      ...
      if (b(8)) {
        ...
        L(f, w), e(f, J, w.values), L(f, {
          ...
          var c = v + (p ? "Clamped" : "") + "Array",
              ...
              S = function(c, d, a) {
                var b = c._d;
                p && (a = (a = Math.round(a)) < 0 ? 0 : a > 255 ? 255 : 255 & a), b.v[V](d * i + b.o, a, Y);
              },
              T = function(b, a) {
                s(b, a, {
                  get: function() {
          ...
          N ? (b = F(function(m, d, s, q) {
            ...
            return M(g, b, c), o(d) ? d instanceof G ? f !== a ? new m(d, x(e, i), f) : e !== a ? new m(d, x(e, i)) : new m(d) : k in d ? H(b, d) : I.call(b, d) : new m(X(d));
      ...
      var a = b(3);
      a(a.P + a.R, "Map", {toJSON: b(209)("Map")});
    }, function(b, e, a) {
      var c = a(154),
          d = a(49);
      b.exports = function(a) {
      ...
      var a = b(3);
      a(a.P + a.R, "Set", {toJSON: b(209)("Set")});
    }, function(c, d, a) {
      var b = a(3);
 ...
 while (!d(e, c = f[b._i++]));
      ...
      var c = a(221),
          b = a(3);
      a(5)._ = c._ = c._ || {}, b(b.P + b.F, "Function", {part: a(220)});
    }, function(c, d, b) {
      var a = b(3);
